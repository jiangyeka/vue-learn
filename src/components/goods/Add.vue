<template>
  <div>
    ...
    <el-dialog title="图片预览" :visible.sync="previewdVisible" width="50%">
  ...
  data () {
    return {
      ...
      addFormRules: {
        ...
        goods_cate: [{ required: true, message: '请选择商品类', trigger: 'blur' }]
      },
      catelist: [],
      cateProps: {
        label: 'cat_name',
